...
import { useOutsideClick } from "../functions/OutsideHooks";
      ...
      <AnimatePresence>
        {active && typeof active === "object" && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-10 w-full h-full bg-black/20 backdrop-blur-sm"
          />
        )}
      </AnimatePresence>
      <AnimatePresence>
        {active && typeof active === "object" ? (
          <div className="fixed inset-0 grid place-items-center z-[100]">
            <motion.button
              ...
              className="absolute flex items-center justify-center w-6 h-6 bg-black rounded-full top-6 right-6 lg:hidden"
            ...
            >
              <motion.div layoutId={`image-${active.title}-${id}`}>
                <Image
                  ...
                  src={active.src}
                  alt={active.title}
                  className="object-cover object-top w-full h-24 lg:h-80 sm:rounded-tr-lg sm:rounded-tl-lg"
                />
              </motion.div>
                ...
                <div className="flex items-start justify-between p-4">
                  <div className="">
                    ...
                    <motion.ScrollShadow
                      ...
                      className="text-base max-h-[100px] text-neutral-600 dark:text-neutral-400"
                    >
                      {active.description}
                    </motion.ScrollShadow>
                  </div>
      ...
      <ul className="grid w-full grid-cols-1 gap-6 md:grid-cols-3">
        {cards.map((card, index) => (
          <motion.div
            ...
            className="flex flex-col p-6 bg-white cursor-pointer hover:bg-neutral-200 dark:hover:bg-neutral-800 rounded-xl"
          >
            <div className="flex flex-col w-full gap-6 bg-black">
              ...
              <div className="flex flex-col items-center justify-center">
                ...
                <motion.ScrollShadow
                  ...
                  className="text-base max-h-[100px] text-center text-neutral-600 dark:text-neutral-400 md:text-left"
                >
                  {card.description}
                </motion.ScrollShadow>
              </div>
...
const cards = [
  {
    description: "What is Degeneratives?",
