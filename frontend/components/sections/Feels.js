...
export default function Feels() {
  ...
  return (
    <div className="relative grid w-full min-h-[calc(100vh-170px)] ">
      <div className="h-[calc(100vh-170px)] md:h-[calc(100vh-130px)] w-full grid md:flex md:flex-row gap-3 py-3 md:px-6">
