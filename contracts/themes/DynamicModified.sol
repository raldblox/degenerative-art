...
contract DynamicMod is IVisualEngine, Ownable(msg.sender) {
    ...
    function generateMetadata(
        ...
        string[] memory adjusted = v3.getEmojis(tokenId + 1);
        // generate image
        string memory image = generateImage(tokenId, owner, adjusted);
        // get mode
        ...
        string memory gridTraits = generateGridTraits(adjusted);
